...
/*
    Created by zaid on 19-08-2008.
 */

public class AndroidHard extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NG.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent New_Game = new Intent(ctx, AndroidTTT.class);
    ...
    int checkWinComp() {
        ...
        if (((Win[0][0] + Win[0][1]) == 6) && checkValidMove(3) == 1 && mainDec == 1) {
            pos = 3;
        } else if (((Win[0][0] + Win[0][2]) == 6) && checkValidMove(2) == 1 && mainDec == 1) {
            pos = 2;
        } else if (((Win[0][1] + Win[0][2]) == 6) && checkValidMove(1) == 1 && mainDec == 1) {
            pos = 1;
        } else if (((Win[1][0] + Win[1][1]) == 6) && checkValidMove(6) == 1 && mainDec == 1) {
            pos = 6;
        } else if (((Win[1][0] + Win[1][2]) == 6) && checkValidMove(5) == 1 && mainDec == 1) {
            pos = 5;
        } else if (((Win[1][1] + Win[1][2]) == 6) && checkValidMove(4) == 1 && mainDec == 1) {
            pos = 4;
        } else if (((Win[2][0] + Win[2][1]) == 6) && checkValidMove(9) == 1 && mainDec == 1) {
            pos = 9;
        } else if (((Win[2][0] + Win[2][2]) == 6) && checkValidMove(8) == 1 && mainDec == 1) {
            pos = 8;
        } else if (((Win[2][1] + Win[2][2]) == 6) && checkValidMove(7) == 1 && mainDec == 1) {
            pos = 7;
        } else if (((Win[0][0] + Win[1][0]) == 6) && checkValidMove(7) == 1 && mainDec == 1) {
            pos = 7;
        } else if (((Win[0][0] + Win[2][0]) == 6) && checkValidMove(4) == 1 && mainDec == 1) {
            pos = 4;
        } else if (((Win[1][0] + Win[2][0]) == 6) && checkValidMove(2) == 1 && mainDec == 1) {
            pos = 1;
        } else if (((Win[0][1] + Win[1][1]) == 6) && checkValidMove(8) == 1 && mainDec == 1) {
            pos = 8;
        } else if (((Win[0][1] + Win[2][1]) == 6) && checkValidMove(5) == 1 && mainDec == 1) {
            pos = 5;
        } else if (((Win[1][1] + Win[2][1]) == 6) && checkValidMove(2) == 1 && mainDec == 1) {
            pos = 2;
        } else if (((Win[0][2] + Win[1][2]) == 6) && checkValidMove(9) == 1 && mainDec == 1) {
            pos = 9;
        } else if (((Win[0][2] + Win[2][2]) == 6) && checkValidMove(6) == 1 && mainDec == 1) {
            pos = 6;
        } else if (((Win[1][2] + Win[2][2]) == 6) && checkValidMove(3) == 1 && mainDec == 1) {
            pos = 3;
        } else if (((Win[1][1] + Win[2][2]) == 6) && checkValidMove(1) == 1 && mainDec == 1) {
            pos = 1;
        } else if (((Win[0][0] + Win[2][2]) == 6) && checkValidMove(5) == 1 && mainDec == 1) {
            pos = 5;
        } else if (((Win[0][0] + Win[1][1]) == 6) && checkValidMove(9) == 1 && mainDec == 1) {
            pos = 9;
        } else if (((Win[1][1] + Win[2][0]) == 6) && checkValidMove(3) == 1 && mainDec == 1) {
            pos = 3;
        } else if (((Win[0][2] + Win[2][0]) == 6) && checkValidMove(5) == 1 && mainDec == 1) {
            pos = 5;
        } else if (((Win[0][2] + Win[1][1]) == 6) && checkValidMove(7) == 1 && mainDec == 1) {
            pos = 7;
        } else {
            pos = DefenciveMove();
        }
